...
class TestGeminiProfileExtraBody:
    """Guards for the live Gemini fallback path (profile → build_extra_body).
    ...
    actually shapes live requests. Regression guards for the two bugs fixed
    2026-07-06 (see docs/routing/HERMES-AGENT-AUDIT.md §3.1):
